...
def main(cfg: DictConfig) -> None:
    ...
    mean_reward, std_reward, mean_profit, std_profit = evaluate_policy(model, env, n_eval_episodes=1)
    ...
    if cfg.run.render_all:
        for n in [2, 4, 10, 30]:
            ...
            env.render_all(last_n_days=n, n_days_offset=0, save_path=save_path)
